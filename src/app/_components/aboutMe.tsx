...
const AboutMe = () => {
    return (
        <section className="bg-slate-50 " id="rolam">
                ...
                <div className="flex flex-col gap-20 md:flex-row">
                    <div className="flex-1">
                        ...
                        <p className="mb-4">
                            ...
                            <Anchor href="#projektek" className="text-primary">
                                Néhány projektem...
                            </Anchor>
                        </p>
                        <p className="mb-8">
                        ...
                        <Anchor className="btn block w-fit " href="#kapcsolat">
                            Kapcsolat
                        </Anchor>
                    </div>
                    <div className="flex-1">
                        ...
                        <ul className="flex flex-wrap gap-4">
                            {TECH_STACK.map((skill, i) => (
                                <li key={i} className="cursor-default rounded bg-gray-200 px-4 py-1 font-semibold transition hover:bg-primary hover:text-solidwhite">
                                    {skill}
                                </li>
                            ))}
                        </ul>
